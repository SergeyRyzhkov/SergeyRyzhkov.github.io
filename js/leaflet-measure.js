...
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"Измерение площади и дистанции\">Измерения</a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3>Измерение площади и дистанции</h3>\n    <ul class=\"tasks\">\n      <a href=\"#\" class=\"js-start start\">Создать измерение</a>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    \n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><a href=\"#\" class=\"js-cancel cancel\">Отмена</a></li>\n      <li><a href=\"#\" class=\"js-finish finish\">Завершить</a></li>\n    </ul>\n  </div>\n</div>");
var resultsTemplate = _.template("<div class=\"group\">\n<p class=\"lastpoint heading\">Последняя точка</p>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n</div>\n<% if (model.pointCount > 1) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Дистанция: </span> <%= model.lengthDisplay %></p>\n</div>\n<% } %>\n<% if (model.pointCount > 2) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Площадь: </span> <%= model.areaDisplay %></p>\n</div>\n<% } %>");
var pointPopupTemplate = _.template("<h3>Координаты точки: </h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Центрировать</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Удалить</a></li>\n</ul>");
var linePopupTemplate = _.template("<p>Дистанция: <%= model.lengthDisplay %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Центрировать</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Удалить</a></li>\n</ul>");
var areaPopupTemplate = _.template("<p>Площадь: <%= model.areaDisplay %></p>\n<p>Периметр: <%= model.lengthDisplay %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Центрировать</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Удалить</a></li>\n</ul>");
...
L.Control.Measure = L.Control.extend({
  ...
  options: {
    ...
    activeColor: '#483D8B',     // base color for map features while actively measuring
    completedColor: '#191970',  // base color for permenant features generated from completed measure
