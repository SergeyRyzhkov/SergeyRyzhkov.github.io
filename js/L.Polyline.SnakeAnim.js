...
L.FeatureGroup.include({
	...
	setSnakingPause: function(snakingPause) {
		this.options.snakingPause = snakingPause;
	},
	...
	snakeIn: function() {
		...
		if (!this._globalmap && !this._mapToAdd) {
			return;
		}
		
		if (this._mapToAdd) {
			this._mapToAdd.removeLayer(this);
		}
